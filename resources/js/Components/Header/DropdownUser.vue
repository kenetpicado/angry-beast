...
<template>
    <div class="relative cursor-pointer" ref="target">
        <div class="flex items-center gap-2" @click.prevent="dropdownOpen = !dropdownOpen">
          <span class="hidden text-right lg:block">
            ...
            <IconChevronDown :class="dropdownOpen && 'rotate-180'" class="hidden fill-current sm:block" width="20"/>
        </div>
