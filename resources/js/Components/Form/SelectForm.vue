  ...
  <div class="mb-4">
    ...
    <div class="relative">
      <select
        ...
        :value="modelValue"
        class="w-full rounded-lg border border-slate-300 bg-transparent py-3 pl-5 pr-10 outline-none focus:outline-none focus:ring-2 focus:ring-green-600 text-slate-600"
      >
        <slot></slot>
      </select>
    </div>
