        ...
        <div class="mx-auto max-w-270">
            <div class="grid grid-cols-4 gap-8">
                <form class="col-span-4 xl:col-span-2" @submit.prevent="handleSubmitProfile">
                    <div
                        class="flex flex-col rounded-sm border border-stroke bg-white h-full">
                ...
                <form class="col-span-4 xl:col-span-2 h-full" @submit.prevent="handleSubmit">
                    <div
                        ...
                        <div class="flex-1 p-7">
                            <InputForm v-model="formPassword.current_password" label="Contraseña actual"
                                       name="current_password" required type="password"/>
                            <InputForm v-model="formPassword.password" label="Nueva contraseña" name="password" required
                                       type="password"/>
                            <InputForm v-model="formPassword.password_confirmation" label="Confirmar contraseña"
